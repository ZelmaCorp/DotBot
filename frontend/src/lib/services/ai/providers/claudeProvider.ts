...
export class ClaudeProvider implements AIProvider {
  ...
  constructor(config: ClaudeConfig) {
    ...
    this.config = {
      apiKey: apiKey || '',
      baseUrl: config.baseUrl || process.env.REACT_APP_CLAUDE_BASE_URL || 'https://api.anthropic.com/v1',
      model: config.model || process.env.REACT_APP_CLAUDE_MODEL || 'claude-sonnet-4-20250514',
