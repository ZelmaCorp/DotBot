        ...
        steps: [
          {
            ...
            parameters: { address: '15oF4uVJwmo4TdGW7VfQxNLavjCXviqxT9S1MgbjMNHr6Sp5', recipient: '14E5nqKAp3oAJcmzgZhUD2RcptBeUBScxKHgJKU4HPNcKVf3', amount: '1000000000000' },
            executionType: 'extrinsic',
            status: 'pending',
            description: 'Transfer 1 DOT',
      ...
      const plan: ExecutionPlan = {
        ...
        steps: [
          ...
          },
          {
            ...
            parameters: { address: '15oF4uVJwmo4TdGW7VfQxNLavjCXviqxT9S1MgbjMNHr6Sp5' },
            executionType: 'data_fetch',
            status: 'pending',
            description: 'Get balance',
